...
const DICTIONARY_ML = {
    no:{
        hei:"Hei på deg",
        hvordanHarDu:"hvordan står det til?",
        braSpørsmål:"Fått noen gode spørsmål i det siste?"
    },
}
const DICTIONARY_NL ={
    en:{
...
console.log(`${DICTIONARY.en.hello} Christian ${DICTIONARY.en.howAreYou}`);
console.log(`${DICTIONARY.en.goodQuestionsLatly}`); 
console.log(`${DICTIONARY.no. hei} Christian ${DICTIONARY.no.hvordanHarDu}`);
console.log(`${DICTIONARY.no.braSpørsmål}`);
